...
const TEAM_LEAGUES = {
    ...
    NEW: 'England', NEWCASTLE: 'England',
    AST: 'England', AVL: 'England', 'ASTON VILLA': 'England',
    BHA: 'England', BRIGHTON: 'England',
    BRE: 'England', BRENTFORD: 'England',
    CRY: 'England', 'CRYSTAL PALACE': 'England',
    EVE: 'England', EVERTON: 'England',
    FUL: 'England', FULHAM: 'England',
    NFO: 'England', NOT: 'England', 'NOTTINGHAM FOREST': 'England', 'NOTTINGHAM': 'England',
    WOL: 'England', WOLVES: 'England', WOLVERHAMPTON: 'England',
    BOU: 'England', BOURNEMOUTH: 'England',
    WHU: 'England', 'WEST HAM': 'England',
    IPS: 'England', IPSWICH: 'England',
    LEI: 'England', LEICESTER: 'England',
    ...
    VIL: 'Spain', VLL: 'Spain', VILLARREAL: 'Spain',
    RSO: 'Spain', SOC: 'Spain', 'REAL SOCIEDAD': 'Spain',
    ...
    MAL: 'Spain', MLL: 'Spain', MALLORCA: 'Spain',
    GET: 'Spain', GETAFE: 'Spain',
    ALV: 'Spain', ALA: 'Spain', ALAVES: 'Spain',
    RAY: 'Spain', 'RAYO VALLECANO': 'Spain', RAYO: 'Spain',
    ESP: 'Spain', ESPANYOL: 'Spain',
    VLD: 'Spain', VALLADOLID: 'Spain',
    ...
    BRE: 'Germany', SVW: 'Germany', 'WERDER BREMEN': 'Germany', BREMEN: 'Germany',
    ...
    LIL: 'France', LOS: 'France', LILLE: 'France',
    ...
    STR: 'France', RCS: 'France', STRASBOURG: 'France',
    TOU: 'France', TFC: 'France', TOULOUSE: 'France',
    REI: 'France', SDR: 'France', REIMS: 'France', 'STADE DE REIMS': 'France',
    NAN: 'France', FCN: 'France', NANTES: 'France',
    BREST: 'France', 'STADE BRESTOIS': 'France',
    AUX: 'France', AUXERRE: 'France',
    ANG: 'France', ANGERS: 'France',
    ...
    MONTP: 'France', MONTPELLIER: 'France'
};
...
function detectLeague(rawLeague = '', home = '', away = '') {
    ...
    // 2. Substring matching in team names
    for (const [teamName, league] of Object.entries(TEAM_LEAGUES)) {
        if (hKey.includes(teamName) || aKey.includes(teamName) || teamName.includes(hKey) || teamName.includes(aKey)) {
            if (hKey.length >= 3 || aKey.length >= 3) {
